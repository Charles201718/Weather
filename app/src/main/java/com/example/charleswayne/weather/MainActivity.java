...
public class MainActivity extends Activity implements View.OnClickListener{
                    ...
                    case XmlPullParser.START_TAG:
                        ...
                        if(todayWeather!=null) {
                            if (xmlPullParser.getName().equals("city")) {
                                ...
                                eventType = xmlPullParser.next();
                                todayWeather.setHight1(xmlPullParser.getText());
                                ...
                                eventType = xmlPullParser.next();
                                todayWeather.setHight2(xmlPullParser.getText());
                                ...
                                eventType = xmlPullParser.next();
                                todayWeather.setHight3(xmlPullParser.getText());
    ...
    void updateTodayWeather(TodayWeather todayWeather)
    {
        ...
        timeT.setText(todayWeather.getUpdatatime());
        ...
        temperature1T.setText(todayWeather.getHight1()+"~"+todayWeather.getLow1());
        temperature2T.setText(todayWeather.getHight2()+"~"+todayWeather.getLow2());
        temperature3T.setText(todayWeather.getHight3()+"~"+todayWeather.getLow3());
